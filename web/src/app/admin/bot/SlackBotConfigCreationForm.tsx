        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating SciOneBot config - ${errorMsg}`
                  : `Error creating SciOneBot config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
          ...
          {({ isSubmitting, values }) => (
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add SciOneBot to the
                ...
                <SectionHeader>When should SciOneBot respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @SciOneBot Only"
                  subtext="If set, SciOneBot will only respond when directly tagged"
                />
                <BooleanFormField
                  name="respond_to_bots"
                  label="Responds to Bot messages"
                  subtext="If not set, SciOneBot will always ignore messages from Bots"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, SciOneBot responses will only be 
                  visible to members in this list. This is
                  useful if you want SciOneBot to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of SciOneBot's response / throw 
                ...
                <BooleanFormField
                  ...
                  label="Should SciOne give a “Still need help?” button?"
                  subtext={`If specified, SciOneBot's response will include a button at the bottom 
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;SciOne Team&apos; or
                        &apos;scione-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents SciOneBot uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that SciOneBot should search
                                through. If left blank, SciOneBot will search
