  ...
  return (
    <>
      <Text>
        ...
        will be queryable within SciOne.
      </Text>
          ...
          <ConnectorForm<SharepointConfig>
            ...
            formBodyBuilder={TextArrayFieldBuilder({
              ...
              subtext:
                ...
                "'support' for the 'scione-ai' sharepoint will cause us to only index documents " +
                "within the 'https://scione-ai.sharepoint.com/sites/support' site. " +
